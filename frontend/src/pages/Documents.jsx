...
import { useDocumentStore, useSocketStore } from '../store';
      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden">
        ...
        <div className="flex-1 overflow-auto p-6">
          <div className="grid grid-cols-2 gap-4">
            {documents.map((doc) => (
              <div key={doc._id} className="bg-surface-dark rounded-xl border border-slate-800 p-5 hover:border-primary/50 transition-colors">
